...
predicted_maps = {
     "without_secondary": {
         "layout_name": "Predicted_Map",
         "layer_name": "NUTS_joined",
         "title_text": "Predicted values from an OLS Model",
         "subtitle_text": "Predicting the share of the population without secondary education",
         "new_layer_name": "Predicted values in %",
         "export_path_png": "maps/predicted_y_without_secondary.png",
         "export_path_pdf": "maps/predicted_y_without_secondary.pdf",
         "field_name": "predicted_y_without_secondary"
     },
     "without_secondary_tongues": {
        ...
        "new_layer_name": "Predicted values in %",
         "export_path_png": "maps/predicted_y_without_secondary_tongues.png",
         "export_path_pdf": "maps/predicted_y_without_secondary_tongues.pdf",
         "field_name": "predicted_y_without_secondary_tongues"
     },
     "pca_comp1": {
        "layout_name": "Predicted_Map",
        "layer_name": "NUTS_joined",
        ...
        "new_layer_name": "Predicted value",
        "export_path_png": "maps/predicted_y_pca.png",
        "export_path_pdf": "maps/predicted_y_pca.pdf",
        "field_name": "predicted_y_pca"
    }
}


def export_predicted_map(predicted_maps):
    for name, map_info in predicted_maps.items():
        ...
        title.attemptResize(QgsLayoutSize(150, 20, QgsUnitTypes.LayoutMillimeters))
        ...
        legend.attemptMove(QgsLayoutPoint(10, 130, QgsUnitTypes.LayoutMillimeters))
...
export_predicted_map(predicted_maps)
